                    ...
                    <div class="">
                        <div class="mb-4">
                            ...
                            <input type="number"
                                ...
                                id="formNik" wire:model="nik">
                            @error('nik') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>

                        <div class="mb-4">
                            <label for="formName" class="block text-gray-700 text-sm font-bold mb-2">No Meteran:</label>
                            <input type="number"
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="formNo_Meteran" wire:model="no_meteran">
                            @error('no_meteran') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text"
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="formAlamat" wire:model="alamat">
